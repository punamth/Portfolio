      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-20 w-full">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
          ...
          >
            ...
            <br/>
             <motion.div
                className="mt-8 flex justify-center md:justify-start items-center w-full"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="flex flex-row gap-4">
                  ...
                  <a
                    href="#projects"
                    className="bg-blush-600 text-gray-800 text-xl px-6 py-3 rounded-md font-semibold shadow hover:bg-blush-700 flex items-center justify-center"
                  >
                    View Projects
                  </a>
                  ...
                  <a
                    href="#contact"
                    className="bg-blush-600 text-gray-800 text-xl px-6 py-3 rounded-md font-semibold shadow hover:bg-blush-700 flex items-center justify-center gap-2"
                  >
                    Contact Me
